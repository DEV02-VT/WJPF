		...
		<div class="col-12 col-sm-8 col-md-6 col-xl-4 alert alert-filter">
			<div class="row justify-content-center  text-center">
				<div class="col-12 div_hidden" id="success_message">
					<?php 
						echo '<div class="alert alert-success" role="alert" text-center>Your password has been successfully reset. You can now log in again at:<br><a href="' . get_page_url('login.php') .'"><p style="text-decoration: underline; text-align: center; color: #333333;">Login</p></a></div>';
					?>
				</div>	
			</div>	
			...
			<div class="row justify-content-center text-center" name="reset_div" id="reset_div" >
				...
				<div class="center">
					<button type="button" name="register_save_btn" id="register_save_btn" class="btn btn-dark">Reset</button>
